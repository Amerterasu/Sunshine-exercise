...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        String preferences = SunshinePreferences.getPreferredWeatherLocation(MainActivity.this);
        new FetchWeatherTask().execute(preferences);
    }
    ...
    class FetchWeatherTask extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... params) {
            ...
            try{
                ...
                String[] parsedJSONResponse = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, response);
        ...
        protected void onPostExecute(String[] results) {
            ...
            // Always remember to consider the case that we get nothing. Don't assume everything works all the time.
            if(results != null){
